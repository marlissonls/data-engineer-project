...
df_states.to_csv("dashboard/df_states_1.csv")
df_brasil.to_csv("dashboard/df_brasil_1.csv")

# =====================================================================
# Data Load
df_states = pd.read_csv("dashboard/df_states_1.csv")
df_brasil = pd.read_csv("dashboard/df_brasil_1.csv")
...
df_states_ = df_states[df_states["data"] == "2020-03-14"]
